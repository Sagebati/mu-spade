...
class GoToPose:
    ...
    def goTo(self, pos, quat={"r1": 0, "r2": 0, "r3": 0, "r4": 0}):
        ...
        print("goal reached:", PositionService.get_current_position_as_map())
    ...
    def rotateD(self, angle_in_degre):
        curr_pos = PositionService.get_current_position_as_map()
...
class Move:
    ...
    def correctPosition(self, target):
        ...
        current_position = PositionService.get_current_position_as_map()
...
if __name__ == "__main__":
    rospy.init_node("test_navigationService", anonymous=False)
    PositionService.get_current_position()
    Move().rotateD(180)
